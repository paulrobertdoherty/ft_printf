...
SRCS = ft_atoi.c ft_bzero.c ft_digits.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
...
ft_num_of_splits.c ft_get_lst_size.c ft_lst_to_array.c

OUT = ft_atoi.o ft_bzero.o ft_digits.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
...
ft_num_of_splits.o ft_get_lst_size.o ft_lst_to_array.o
